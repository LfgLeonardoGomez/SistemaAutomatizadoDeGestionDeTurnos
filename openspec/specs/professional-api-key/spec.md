...
Allow authenticated professionals to generate secure API keys for machine-to-machine integrations, and provide a reusable dependency to validate those keys on integration endpoints.
